        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="/inputbarang/store" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-group row">
                            <label for="Nama Barang" class="col-sm-2 col-form-label">Nama Barang</label>
                            <input type="text" class="form-control col-md-8" name="nama_barang"/>
                        </div>

                        <div class="form-group row">
                            <label for="Stock Barang" class="col-sm-2 col-form-label">Stock Barang</label>
                            <input type="number" class="form-control col-md-8" name="stock"/>
                        </div>

                        <div class="form-group row">
                            <label for="Harga Normal" class="col-sm-2 col-form-label">Harga Normal</label>
                            <input type="text" class="form-control col-md-8" name="harga"/>
                        </div>

                        <div class="form-group row">
                            <label for="Harga Member" class="col-sm-2 col-form-label">Harga Member</label>
                            <input type="text" class="form-control col-md-8" name="harga_member"/>
                        </div>

                        <div class="form-group row">
                            <label for="Keterangan" class="col-sm-2 col-form-label">Keterangan</label>
                            <textarea class="form-control col-md-8" maxlength="250" name="keterangan" /></textarea>
                        </div>
